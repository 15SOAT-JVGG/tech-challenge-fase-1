package br.com.fiap.postech.soat16.fase1.vehicle.adapter.in.rest.openapi;
...
public interface VehicleControllerDocs {
    ...
    Uni<VehicleResponseDto> findByLicensePlate(
            @Parameter(name = "license_plate", description = "Vehicle license plate",
                    required = true, in = ParameterIn.PATH)
    ...
    @Operation(summary = "Delete vehicle",
            description = "Permanently removes a vehicle by identifier.")
