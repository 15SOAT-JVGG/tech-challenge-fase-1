...
/**
 * {@link WorkOrderHistoryRepository} não declara consultas customizadas, então estes testes
 * cobrem o CRUD herdado de {@code PanacheRepository} (persist/findById) sobre um banco real.
 */
@QuarkusTest
...
class WorkOrderHistoryRepositoryIT {
    ...
    // Matches Vehicle's license plate pattern (^[A-Z]{3}\d[A-Z\d]\d{2}$), e.g. "WOH9A01".
