...
public interface AttendantControllerDocs {
    ...
    PageableResponse<AttendantResponse> findAll(@BeanParam @Valid PageableRequest pageable);
    ...
    Response create(
            @RequestBody(required = true, description = "Attendant data for registration")
    ...
    AttendantLoginResponse login(
            @RequestBody(required = true, description = "Attendant credentials")
    ...
    Response update(
            @Parameter(name = "id", description = "Attendant identifier", required = true, in = ParameterIn.PATH)
            @PathParam("id") UUID id,
            @RequestBody(required = true, description = "Updated attendant data")
