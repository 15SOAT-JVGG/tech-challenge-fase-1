package br.com.fiap.postech.soat16.fase1.servicecatalog.adapter.in.rest.openapi;
...
public interface ServiceItemControllerDocs {
    ...
    @APIResponse(
            ...
            content = @Content(
                    ...
                    schema = @Schema(
                            implementation = ServiceItemResponseDto.class,
    ...
    @Operation(
            ...
            description = "Returns a single catalog service by its identifier.")
    @APIResponse(
            responseCode = "200",
