...
public class CustomerController implements CustomerControllerDocs {
    ...
    @POST
    @Override
    public Uni<Response> create(@RequestBody @Valid CustomerCreateRequest dto) {
    ...
    @Path("/{id}")
    @Override
    public Uni<Response> update(@PathParam("id") UUID id, @RequestBody @Valid CustomerUpdateRequest dto) {
