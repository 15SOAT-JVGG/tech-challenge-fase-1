...
/**
 * Canal voltado ao cliente final, separado das APIs administrativas. Nesta versao (MVP) a posse do
 * identificador da OS funciona como capacidade de acesso (sem login de cliente); uma evolucao
...
public interface PublicWorkOrderControllerDocs {
    ...
    // CPD-OFF — anotacoes OpenAPI deste canal espelham, por contrato, as do WorkOrderControllerDocs.
